...
GAME_OPTION("弃牌时间（秒）", 弃牌时间, (ArithChecker<uint32_t>(10, 3600, "弃牌时间（秒）")), 200)
GAME_OPTION("玩家初始金币数", 初始金币数, (ArithChecker<uint32_t>(100, 100000, "金币数")), 300)
GAME_OPTION("回合数", 回合数, (ArithChecker<uint32_t>(1, 10, "回合数")), 3)
GAME_OPTION("随机种子", 种子, (AnyArg("种子", "我是随便输入的一个字符串")), "")
// GAME_OPTION("游戏结束时牌型后一位获得金币占前一位的比例（%）", 奖励比例, (ArithChecker<uint32_t>(0, 100, "倍数")), 50)
GAME_OPTION("末尾玩家扣除金币比例（%）", 惩罚比例, (ArithChecker<uint32_t>(0, 1, "比例")), 25)
