...
void new_game(MessageIterator& msg)
{
  ...
  if (msg.has_next())
  {
    ...
    if (match_type == "公开")
    {
      switch (msg.type_)
      {
        case PRIVATE_MSG:
          ...
          return;
        case GROUP_MSG:
          msg.ReplyErrorOrMsg(match_manager.new_match(GROUP_MATCH, gamename, msg.usr_qq_, msg.src_qq_), "创建游戏成功！");
          break;
        case DISCUSS_MATCH:
          msg.ReplyErrorOrMsg(match_manager.new_match(DISCUSS_MATCH, gamename, msg.usr_qq_, msg.src_qq_), "创建游戏成功！");
          break;
        default:
          /* Never reach here! */
          assert(false);
    ...
    {
      msg.ReplyErrorOrMsg(match_manager.new_match(PRIVATE_MATCH, gamename, msg.usr_qq_, INVALID_QQ), "创建游戏成功！");
    }
    else
    {
...
void start_game(MessageIterator& msg)
{
  ...
  msg.ReplyErrorOrMsg(match_manager.StartGame(msg.usr_qq_), "游戏开始！");
}
