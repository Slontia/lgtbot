...
extern "C"
{
  ...
  DLLEXPORT(bool) Init(const NEW_BOARDCAST_MSG_SENDER_CALLBACK, const NEW_TELL_MSG_SENDER_CALLBACK, const DELETE_GAME_MSG_SENDER_CALLBACK, const GAME_PREPARE_CALLBACK, const GAME_OVER_CALLBACK, const START_TIMER_CALLBACK, const STOP_TIMER_CALLBACK);
